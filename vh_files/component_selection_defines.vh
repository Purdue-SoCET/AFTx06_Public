...
`define COMPONENT_SELECTION_DEFINES_VH// ISA Params:
localparam XLEN = 32;// Microarch Params:
...
`define BUS_INTERFACE_AHB// RISC-MGMT Extensions:
`define NUM_EXTENSIONS 1
`define RISC_MGMT_EXTENSIONS	\
	`ADD_EXTENSION_WITH_OPCODE(template,0,7'b0001011)`endif // COMPONENT_SELECTION_DEFINES_VH
